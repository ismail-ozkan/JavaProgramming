...
version 2: with instance variables and with a setInfo method (or constructor) that sets value to integers
 which will be used in instance methods of the class we create
for example:
