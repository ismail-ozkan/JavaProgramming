...
public class ArraysPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(scores));//[0, 85, 95, 0, 0]


        System.out.println("----------------------------------------");

        String[] months = {"January", "February", "March", "April", "May", "June", "July",
                "August", "September", "October", "November", "December"};// 0 - 11 indexes
/*
...
*/
        ...
        for (int i = 0; i < months.length; i++) {//i: represents the index numbers of a rray starting from 0
